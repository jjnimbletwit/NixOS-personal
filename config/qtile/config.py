...
keys = [
    ...
    Key(["mod4", "shift"], "s", lazy.spawn("sh -c 'slurp | grim -g - - | wl-copy'"), desc="Screenshot"),
    Key([], "XF86AudioPlay", lazy.spawn("playerctl --player=ncspot play-pause")),
...
screens = [
    Screen(
        wallpaper="/home/Jasper/wallpapers/desktop/background1.png",
        wallpaper_mode="fill",
        top=bar.Bar(
            widgets = [
